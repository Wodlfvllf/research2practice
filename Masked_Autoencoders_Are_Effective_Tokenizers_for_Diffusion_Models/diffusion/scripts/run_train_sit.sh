#!/usr/bin/env bash
#
# Script to run the training for the SiT diffusion model.
#
...
CHECKPOINT_DIR="./diffusion/checkpoints/sit_model"
...
# --- Run Training ---
echo "Starting SiT model training..."
echo "Dataset: $DATA_PATH"
echo "Tokenizer: $TOKENIZER_PATH"
echo "Checkpoints will be saved to: $CHECKPOINT_DIR"

python -m diffusion.src.diffusion.training.train_sit \
    --data-path "$DATA_PATH" \
